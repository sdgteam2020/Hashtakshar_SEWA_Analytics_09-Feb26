...
public interface IDashboardService
{
    ...
    Task<(List<GetInstallAppDataResponse> Data, int TotalCount, int FilteredCount)> GetHastaksharSewaInstallationsQuery(
        int start,
        int length,
        string? searchValue,
        CancellationToken cancellationToken = default);

    Task<(List<GetInstallAppDataResponse> Data, int TotalCount, int FilteredCount)> GetHastaksharSewaDailyRunQuery(
        int start,
        int length,
        string? searchValue,
        CancellationToken cancellationToken = default);
    ...
    Task<(List<GetPublicKeyValtResponse> Data, int TotalCount, int FilteredCount)> GetVaultMasterData(
        int start,
        int length,
        string? searchValue,
        CancellationToken cancellationToken = default);
